...
var require_wide_truncate = __commonJS({
  "libs/core/src/lib/npmlog/gauge/wide-truncate.ts"(exports2, module2) {
    ...
    function wideTruncate(str, target) {
      ...
      var noAnsi = util5.stripVTControlCharacters(str);
...
var require_error = __commonJS({
  "libs/core/src/lib/npmlog/gauge/error.ts"(exports2) {
    ...
    exports2.MissingTemplateValue = function MissingTemplateValue(item, values) {
      var err = new User(util5.format('Missing template value "%s"', item.type));
...
var import_dedent, import_node_os2, import_yargs;
var init_cli = __esm({
  "libs/core/src/lib/cli.ts"() {
    "use strict";
    ...
    Package = class _Package {
      ...
      get contents() {
        ...
        if (publishConfig && publishConfig.directory) {
          return import_path2.default.join(this.location, publishConfig.directory);
        }
...
function makeFileFinder(rootPath, packageConfigs) {
  ...
  return (fileName, fileMapper, customGlobOpts) => {
    ...
    const promise = (0, import_p_map.default)(
      ...
      (globPath) => {
        let chain = (0, import_tinyglobby.glob)(import_path4.default.posix.join(globPath, fileName), options);
...
var import_tinyglobby, import_p_map, import_path4;
...
var import_devkit2, import_cosmiconfig, import_dedent2, import_fs2, import_glob_parent, import_tinyglobby2, import_js_yaml, import_load_json_file2, import_p_map2, import_path5, LICENSE_GLOB, Project, getPackages, getPackagesSync;
...
var import_os, import_path6, import_write_file_atomic;
...
async function createProjectGraphWithPackages(projectGraph, projectFileMap, packageConfigs) {
  ...
  Object.values(projectGraphWithOrderedNodes.dependencies).forEach((projectDeps) => {
    ...
    for (const dep of workspaceDeps) {
      ...
      const targetMatchesRequirement = hasWorkspaceProtocol || resolvedTarget.fetchSpec === targetPkg.location || (0, import_semver2.satisfies)(
        targetPkg.version,
...
var import_devkit3, import_fs_extra, import_minimatch2, import_npm_package_arg2, import_path8, import_semver2, resolvePackage;
...
var import_dedent3, import_client, import_os2, DEFAULT_CONCURRENCY, Command;
...
async function oidc({ packageName, registry, opts, config }) {
  try {
    ...
    (import_ci_info.default.GITHUB_ACTIONS || /** @see https://github.com/watson/ci-info/blob/v4.2.0/vendors.json#L161C13-L161C22 */
    import_ci_info.default.GITLAB)) {
      return void 0;
    }
    let idToken = process.env["NPM_ID_TOKEN"];
    if (!idToken && import_ci_info.default.GITHUB_ACTIONS) {
      ...
      const url2 = new URL(process.env["ACTIONS_ID_TOKEN_REQUEST_URL"]);
      url2.searchParams.append("audience", audience);
      const startTime = Date.now();
      const response2 = await (0, import_make_fetch_happen.default)(url2.href, {
        retry: opts.retry,
        headers: {
      ...
      npmlog_default.http("fetch", `GET ${url2.href} ${response2.status} ${elapsedTime}ms`);
    ...
    const escapedPackageName = (0, import_npm_package_arg5.default)(packageName).escapedName;
    let response;
    try {
      response = await import_npm_registry_fetch.default.json(
    ...
    try {
      ...
      if (headerB64 && payloadB64) {
        ...
        if (import_ci_info.default.GITHUB_ACTIONS && payload.repository_visibility === "public" || // only set provenance for gitlab if the repo is public and SIGSTORE_ID_TOKEN is available
...
var require_defaults = __commonJS({
  "libs/core/src/lib/npm-conf/defaults.ts"(exports2) {
    ...
    var import_path27 = __toESM(require("path"));
    var temp = import_os6.default.tmpdir();
    ...
    var home = import_os6.default.homedir();
    if (home) {
    ...
    Object.defineProperty(exports2, "defaults", {
      get() {
        ...
        defaults = {
          ...
          usage: false,
          user: process.platform === "win32" || import_os6.default.type() === "OS400" ? 0 : "nobody",
...
async function npmPublish(pkg2, tarFilePath, options, conf, otpCache) {
  ...
  const { scope } = (0, import_npm_package_arg6.default)(pkg2.name);
  const opts = {
    log: npmlog_default,
    ...remainingOptions,
    projectScope: scope
  ...
  if (!dryRun) {
    ...
    const [tarData, npmCliPackageJson] = await Promise.all([
      ...
      await (0, import_package_json.prepare)(import_path14.default.dirname(manifestLocation))
    ]);
...
var import_package_json, import_fs_extra5, import_libnpmpublish, import_npm_package_arg6, import_path14;
...
var import_node_fs, import_is_stream, import_make_dir, import_path16, import_temp_dir, import_util2, uuid, writeFileP, tempfile, writeStream, temp_write_default;
var init_temp_write = __esm({
  "libs/core/src/lib/temp-write.ts"() {
    ...
    writeFileP = (0, import_util2.promisify)(import_node_fs.default.writeFile);
...
async function packDirectory(_pkg, dir, options) {
  ...
  const tarFilePath = await temp_write_default(stream3, getTarballName(pkg2));
...
var import_make_fetch_happen2, import_path18, GitLabClient;
...
var import_npm_package_arg8, PackageGraph;
      ...
      constructor(packages, graphType = "allDependencies", forceLocal) {
        ...
        this.forEach((currentNode, currentName) => {
          ...
          Object.keys(graphDependencies).forEach((depName) => {
            ...
            const resolved = import_npm_package_arg8.default.resolve(depName, spec, currentNode.location);
...
var import_os3, import_path20, import_write_file_atomic2;
...
function logPackageError2(err, stream3 = false) {
  npmlog_default.error(err.command, `exited ${err.exitCode} in '${err.pkg.name}'`);
  if (stream3) {
    return;
  }
...
var import_dedent5, import_execa3, import_os4, DEFAULT_CONCURRENCY2, Command2;
...
var init_src7 = __esm({
  "libs/commands/import/src/index.ts"() {
    ...
    ImportCommand = class extends Command {
      externalExecOpts = { cwd: "" };
      targetDirRelativeToGitRoot;
      commits = [];
      origGitEmail;
      origGitName;
      preImportHead;
...
function gitCommit(message, { amend, commitHooks, signGitCommit, signoffGitCommit, overrideMessage }, opts) {
  ...
  if (shouldChangeMessage) {
    if (message.indexOf(import_os5.EOL) > -1) {
    ...
    var VersionCommand = class extends Command {
      ...
      confirmVersions() {
        if (this.options.json) {
          ...
          output("");
          output("Changes:");
          output(changes.join(import_os6.default.EOL));
          output("");
        }
        if (this.options.yes) {
      ...
      async gitCommitAndTagVersionForUpdates() {
        ...
        const message = tags.reduce((msg, tag) => `${msg}${import_os6.default.EOL} - ${tag}`, `${subject}${import_os6.default.EOL}`);
...
async function getCurrentTags(execOpts, matchingPattern) {
  ...
  if (matchingPattern === "*@*") {
    return lines.map((tag) => (0, import_npm_package_arg9.default)(tag).name);
  }
  return lines;
}
var import_npm_package_arg9, childProcess26;
var init_get_current_tags = __esm({
  "libs/commands/publish/src/lib/get-current-tags.ts"() {
    "use strict";
    init_src2();
    import_npm_package_arg9 = __toESM(require("npm-package-arg"));
...
function getProfileData(opts) {
  ...
  return pulseTillDone(import_npm_registry_fetch3.default.json("/-/npm/v1/user", opts)).then((data) => {
...
function getWhoAmI(opts) {
  ...
  return pulseTillDone(import_npm_registry_fetch4.default.json("/-/whoami", opts)).then((data) => {
    opts.log.silly("npm whoami", "received %j", data);
    return data;
  });
}
var import_npm_registry_fetch4;
var init_get_whoami = __esm({
  "libs/commands/publish/src/lib/get-whoami.ts"() {
    "use strict";
    init_src2();
    import_npm_registry_fetch4 = __toESM(require("npm-registry-fetch"));
  }
});
...
function verifyNpmPackageAccess(packages, username, options) {
  ...
  return pulseTillDone(import_libnpmaccess2.default.getPackages(username, opts)).then(success, failure);
  function success(result) {
...
var import_libnpmaccess2;
var init_verify_npm_package_access = __esm({
  "libs/commands/publish/src/lib/verify-npm-package-access.ts"() {
    "use strict";
    init_src2();
    import_libnpmaccess2 = __toESM(require("libnpmaccess"));
    init_fetch_config();
  }
});
...
var require_src3 = __commonJS({
  "libs/commands/publish/src/index.ts"(exports2, module2) {
    ...
    var import_npm_package_arg10 = __toESM(require("npm-package-arg"));
    var import_p_map10 = __toESM(require("p-map"));
    var import_p_pipe = __toESM(require("p-pipe"));
    var import_semver9 = __toESM(require("semver"));
    ...
    var PublishCommand = class extends Command {
      ...
      configureProperties() {
        ...
        this.npmSession = import_node_crypto.default.randomBytes(8).toString("hex");
      ...
      async execute() {
        ...
        if (this.options.summaryFile !== void 0) {
          ...
          output(jsonObject);
          try {
            import_node_fs2.default.writeFileSync(filePath, JSON.stringify(jsonObject));
          ...
          output(message.join(import_node_os3.default.EOL));
        }
      ...
      async detectFromGit() {
        ...
        if (!taggedPackageNames.length) {
          ...
          taggedPackageNames.forEach((tag) => {
            const npaResult = (0, import_npm_package_arg10.default)(tag);
        ...
        await (0, import_p_map10.default)(updatesWithWorkspaceLinks, (node) => {
          ...
          dependencies.forEach((dep) => {
            ...
            if (resolved.workspaceSpec) {
              ...
              pkg2.updateLocalDependency(resolved, depVersion, savePrefix, { eraseWorkspacePrefix: true });
            }
          });
        });
      }
      ...
      async resetChanges() {
        ...
        const dirtyManifests = [this.project.manifest].concat(this.packagesToPublish).map((pkg2) => import_node_path.default.relative(_workspaceRoot, pkg2.manifestLocation));
        try {
      ...
      execScript(pkg2, script) {
        const scriptLocation = import_node_path.default.join(pkg2.location, "scripts", script);
        try {
        ...
        const mapper = (0, import_p_pipe.default)(
          ...[
            ...
            (pkg2) => pulseTillDone(packDirectory(pkg2, pkg2.location, opts)).then((packed) => {
              tracker.verbose("packed", import_node_path.default.relative(this.project.rootPath, pkg2.contents));
              tracker.completeWork(1);
              pkg2.packed = packed;
              return pkg2.refresh();
            })
          ...
          ...[
            (pkg2) => {
              ...
              return pulseTillDone(
                queue2 ? queue2.queue(() => npmPublish(pkg2, pkg2.packed.tarFilePath, pkgOpts, this.conf, this.otpCache)) : npmPublish(pkg2, pkg2.packed.tarFilePath, pkgOpts, this.conf, this.otpCache)
              ).then(() => {
      ...
      async copyAssets(pkg2) {
        ...
        if ((0, import_node_path.normalize)(pkg2.location) === (0, import_node_path.normalize)(pkg2.contents)) {
          return;
        }
        const _workspaceRoot = process.env["NX_WORKSPACE_ROOT_PATH"] || import_devkit9.workspaceRoot;
        const assets = pkg2.lernaConfig?.command?.publish?.assets;
        const filesToCopy = [];
        const getFiles = (assetGlob) => (0, import_tinyglobby3.glob)(assetGlob, {
          cwd: pkg2.location,
          onlyFiles: false,
          expandDirectories: false
        });
        for (const asset of assets) {
          if (typeof asset === "string") {
            ...
            for (const file of files) {
              filesToCopy.push({
                from: (0, import_node_path.join)(pkg2.location, file),
                to: (0, import_node_path.join)(pkg2.contents, file)
              });
            }
            ...
            for (const file of files) {
              filesToCopy.push({
                from: (0, import_node_path.join)(pkg2.location, file),
                to: (0, import_node_path.join)(pkg2.contents, asset.to, (0, import_node_path.basename)(file))
              });
            }
          } else {
            throw new ValidationError(
        ...
        for (const file of filesToCopy) {
          if ((0, import_node_path.normalize)(file.from) === (0, import_node_path.normalize)(file.to)) {
            this.logger.warn(
              "EPUBLISHASSET",
              "Asset %s is already in package directory",
              file.from.replace(`${_workspaceRoot}/`, "")
            );
          } else if ((0, import_node_fs2.existsSync)(file.from)) {
            this.logger.verbose(
              "publish",
      ...
      getSummaryFilePath() {
        ...
        if (this.options.summaryFile === "") {
          return import_node_path.default.join(process.cwd(), "./lerna-publish-summary.json");
        }
        const normalizedPath = import_node_path.default.normalize(this.options.summaryFile);
        if (normalizedPath === "") {
          throw new Error("summaryFile is not a valid path.");
        }
        if (normalizedPath.endsWith(".json")) {
          return import_node_path.default.join(process.cwd(), normalizedPath);
        }
        return import_node_path.default.join(process.cwd(), normalizedPath, "lerna-publish-summary.json");
      }
    };
...
function explicitlyHandleLegacyPackageManagementCommands(yargsInstance) {
