...
function deLiner() {
  ...
  var last = "";
  return new import_node_stream.default.Transform({
...
function textFormatter(options) {
  ...
  function textify(logEvent) {
    var line = import_node_util.default.format("%s%s", textifyTags(logEvent.tag), logEvent.msg.toString());
    if (options.timeStamp) {
      line = import_node_util.default.format("%s %s", new Date(logEvent.time).toISOString(), line);
    }
...
function createDuplex(input, output2) {
  const duplex = new import_node_stream.default.Duplex({
    objectMode: false,
    allowHalfOpen: false
  });
...
var import_node_stream, import_node_string_decoder, import_node_util, import_through, forked_strong_log_transformer_default, formatters;
var init_forked_strong_log_transformer = __esm({
  "libs/child-process/src/forked-strong-log-transformer.ts"() {
    ...
    forked_strong_log_transformer_default = Logger;
    Logger.DEFAULTS = {
      format: "text",
      tag: "",
...
var import_node_stream2, TrackerStream;
var init_tracker_stream = __esm({
  "libs/core/src/lib/npmlog/are-we-there-yet/tracker-stream.ts"() {
    "use strict";
    import_node_stream2 = __toESM(require("node:stream"));
    init_tracker();
    TrackerStream = class extends import_node_stream2.default.Transform {
      tracker;
      name;
      id;
...
var import_node_events2, import_node_util2, setBlocking, consoleControl, Logger2, log, trackerConstructors, mixinLog, npmlog_default;
var init_npmlog = __esm({
  "libs/core/src/lib/npmlog/index.ts"() {
    ...
    setBlocking(true);
    Logger2 = class extends import_node_events2.EventEmitter {
      _stream;
      _paused;
      _buffer;
      unicodeEnabled;
      ...
      log(lvl, prefix, ...messageArgs) {
        ...
        if (l === void 0) {
          this.emit("error", new Error(import_node_util2.default.format("Undefined log level: %j", lvl)));
          return;
        }
        let stack = null;
        ...
        const message = import_node_util2.default.format(...a);
        const m = {
          id: this.id++,
          level: lvl,
...
var import_npm_package_arg6 = __toESM(require("npm-package-arg"));
init_npmlog();

// libs/core/src/lib/oidc.ts
var import_ci_info = __toESM(require("ci-info"));
var import_libnpmaccess = __toESM(require("libnpmaccess"));
var import_make_fetch_happen = __toESM(require("make-fetch-happen"));
...
var writeFileP = (0, import_util.promisify)(import_node_fs.default.writeFile);
...
var import_make_fetch_happen2 = __toESM(require("make-fetch-happen"));
init_npmlog();
