...
var import_node_fs, import_is_stream, import_make_dir, import_path8, import_temp_dir, import_util, uuid, writeFileP, tempfile, writeStream, temp_write_default;
...
function gitCommit(message, { amend, commitHooks, signGitCommit, signoffGitCommit, overrideMessage }, opts) {
  ...
  if (shouldChangeMessage) {
    if (message.indexOf(import_os2.EOL) > -1) {
