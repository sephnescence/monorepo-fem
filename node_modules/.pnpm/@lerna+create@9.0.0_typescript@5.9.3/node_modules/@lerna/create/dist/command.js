...
var import_os2, import_path9, import_write_file_atomic2;
...
var import_dedent5, import_execa3, import_os3, DEFAULT_CONCURRENCY2, Command2;
  ...
  "libs/commands/create/src/index.ts"(exports2, module2) {
    ...
    var CreateCommand = class extends Command2 {
      initialize() {
        ...
        const { name, scope } = (0, import_npm_package_arg9.default)(pkgName);
      ...
      resolveRelative(depNode) {
        ...
        const spec = import_npm_package_arg9.default.resolve(depNode.name, relPath, this.targetDir);
      ...
      setDependencies() {
        ...
        chain = chain.then(
          () => (0, import_p_reduce.default)(
            inputs,
            (obj, input) => {
              const spec = (0, import_npm_package_arg9.default)(input);
